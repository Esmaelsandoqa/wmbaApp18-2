...
namespace wmbaApp.Data.WMMigrations
{
    ...
    [Migration("20240217190031_adplingam3")]
    partial class adplingam3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("wmbaApp.Models.Player", b =>
                {
                    ...
                    b.Property<int?>("playersLineUpId1")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("wmbaApp.Models.Player", b =>
                {
                    ...
                    b.HasOne("wmbaApp.Models.PlayersLineUp", null)
                        .WithMany("CompetatorPlayers")
                        .HasForeignKey("playersLineUpId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("wmbaApp.Models.PlayersLineUp", "playersLineUp")
                        .WithMany("Players")
                        .HasForeignKey("playersLineUpId1");
            ...
            modelBuilder.Entity("wmbaApp.Models.PlayersLineUp", b =>
                {
                    b.Navigation("CompetatorPlayers");
